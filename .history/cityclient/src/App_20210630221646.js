...
class App extends Component {
  ...
  handlerSubmit = async (e) => {
    ...
    try {
      ...
      let axiosLocalApi= await axios.get(`http://localhost:8000/weather?key=pk.0a80fd547a3c1e8574e39921b81514c5&lon=${this.state.longitude}&lat=${this.state.latitude}&searchQuery=${this.state.city_name}`)
