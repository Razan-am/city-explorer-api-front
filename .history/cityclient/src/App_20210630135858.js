...
class App extends Component {
  ...
  handlerSubmit = async (e) => {
    ...
    try {
      ...
      const axiosLocalApi = await axios.get(`http://localhost:8000/weather/?key=1ce9a45e3f574b64af6379c6c4a8b0cc&lat=${this.state.lat}&lon=${this.state.lon}&searchQuery=${this.state.city_name}`)
      this.setState({
