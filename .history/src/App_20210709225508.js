  ...
  render() {
    return (
      <div style={{ backgroundColor:'beige'}}>
        <h1 style={{ position:'center'}}>Please enter a city name </h1>
        <AlertMessage
          alert={this.state.alert}
          error={this.state.error} />
        <form onSubmit={this.handlerSubmit} style={{ marginLeft: '500px', paddingTop: '20px', marginButton: '20px', display: 'block', width: '50px' }}>
